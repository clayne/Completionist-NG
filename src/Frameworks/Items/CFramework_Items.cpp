...
namespace CFramework_Items {
	...
	void CHandler::InjectAndCompileData() {
		...
		Data.CompileFormArray(CFramework_Items::SkyrimForms, "Skyrim.esm");
		Data.CompileFormArray(CFramework_Items::DawnguardForms, "Dawnguard.esm");
		Data.CompileFormArray(CFramework_Items::HearthfireForms, "HearthFires.esm");
		Data.CompileFormArray(CFramework_Items::DragonbornForms, "Dragonborn.esm");
		Data.MergeAsCollectable();

		CFramework_Items::Data.Populate(NameArray, FormArray, BoolArray);
