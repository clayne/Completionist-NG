...
namespace CPatch_FSK {
	...
	void CHandler::InjectAndCompileData() {
		...
		CPatch_FSK_Books::Data.Populate(Books_NameArray, Books_FormArray, Books_BoolArray, Books_TextArray);
		CPatch_FSK_MapMa::Data.Populate(MapMa_NameArray, MapMa_FormArray, MapMa_BoolArray, MapMa_TextArray, true);
